...
class Tester:
    def __init__(self, args):
        ...
        self.image_dir = os.path.join(self.te_data_path, "test_images")
        if self.data_mode == "RGBD":
            self.depth_dir = os.path.join(self.te_data_path, "test_depth")
        else:
            self.depth_dir = ""

        self.has_masks = args.has_masks
        if self.has_masks:
            self.mask_dir = os.path.join(self.te_data_path, "test_masks")
        else:
            self.mask_dir = ""
