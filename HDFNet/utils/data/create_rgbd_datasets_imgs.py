...
def _make_test_dataset(root, prefix=(".jpg", ".png")):
    img_path = os.path.join(root, "test_images")
    mask_path = os.path.join(root, "test_masks")
    depth_path = os.path.join(root, "test_depth")
...
def _make_test_dataset_from_list(list_filepath, prefix=(".jpg", ".png")):
    ...
    return [
        (
            os.path.join(os.path.join(os.path.dirname(img_path), "test_images"), os.path.basename(img_path) + prefix[0]),
            os.path.join(os.path.join(os.path.dirname(img_path), "test_masks"), os.path.basename(img_path) + prefix[1]),
            os.path.join(os.path.join(os.path.dirname(img_path), "test_depth"), os.path.basename(img_path) + prefix[1]),
        )
...
def _make_train_dataset_from_list(list_filepath, prefix=(".jpg", ".png")):
    ...
    return [
        (
            os.path.join(os.path.join(os.path.dirname(img_path), "train_images"), os.path.basename(img_path) + prefix[0]),
            os.path.join(os.path.join(os.path.dirname(img_path), "train_masks"), os.path.basename(img_path) + prefix[1]),
            os.path.join(os.path.join(os.path.dirname(img_path), "train_depth"), os.path.basename(img_path) + prefix[1]),
        )
        for img_path in img_list
    ]
