...
parser.add_argument('--test_datasets', type=str, default=['NLPR'], nargs='+', help='test dataset')
...
# build model
pretrain="resnet_dy_pretrained.pth"
model = RD3D(32, pretrain).cuda()
...
for dataset in test_datasets:
    ...
    image_root = os.path.join(dataset_path, dataset, 'test_data/test_images')
    gt_root = os.path.join(dataset_path, dataset, 'test_data/test_masks')
    depth_root = os.path.join(dataset_path, dataset, 'test_data/test_depth')
